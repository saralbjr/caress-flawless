      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div className="space-y-4">
            <Link href="/" className="text-2xl font-bold text-primary inline-flex items-center">
              ShopNest
            </Link>
            <p className="text-muted-foreground max-w-xs">
              Your one-stop shop for all your shopping needs. Quality products at the best prices.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/products?category=clothing" className="text-muted-foreground hover:text-primary transition-colors">
                  Clothing
                </Link>
              </li>
              <li>
                <Link href="/products?category=home" className="text-muted-foreground hover:text-primary transition-colors">
                  Home & Kitchen
                </Link>
              </li>
              <li>
                <Link href="/products?category=beauty" className="text-muted-foreground hover:text-primary transition-colors">
                  Beauty
                </Link>
              </li>
            </ul>
